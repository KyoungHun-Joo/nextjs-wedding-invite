...
export const MapSection: React.FunctionComponent<any> = props => {
    return (
        <>
            <section
                className="location-section mcard_29"
            ...
            >
                ...
                >
                    ...
                    <img
                        src="/static/images/section_shape.png"
                        alt="Shape"
                        style={{ paddingBottom: "10%" }}
                    />
                </div>
                <div className="map-area">
                    <div className="head">
                        ...
                        <div className="txt">
                            <p>
                                서울특별시 서초구 반포대로 235 (반포동), 반포
                                효성빌딩 LL층(지하1층)
                            </p>{" "}
                            <p>Tel. 02-3431-0230</p>
                        </div>
                        {/* <button onClick={()=>"toCall('02-941-7711')"} className="tel">전화걸기</button> */}
                    </div>
                    <img src="/images/map1.png" alt="Build Status" />
                </div>
                <div className="info">
                    <div className="contain">
                        <dl>
                            <dt className="">지하철</dt>
                            <dd className="">
                                고속터미널역 5번 출구(3호선, 7호선, 9호선)
                                방향으로 나와 서래공원 방면 신호등 건넌 후
                                첫번째 건물 (반포 효설빌딩) LL층
                            </dd>
                        </dl>
                        <dl>
